...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
     ...
     * 月份计划农历文本颜色
     */
    protected Paint mSchemeMonthTextPaint = new Paint();
    /**
     * 月份计划农历文本颜色
     */
    ...
    private void initPaint(Context context) {
        ...
        mSchemeMonthTextPaint.setAntiAlias(true);
        mSchemeMonthTextPaint.setTextAlign(Paint.Align.CENTER);
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        this.mSchemeMonthTextPaint.setColor(delegate.getSchemeMonthTextColor());
        ...
        this.mSchemeMonthTextPaint.setTextSize(delegate.getDayTextSize());
