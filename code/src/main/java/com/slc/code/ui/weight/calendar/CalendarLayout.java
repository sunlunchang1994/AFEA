 ...
 */
package com.slc.code.ui.weight.calendar;
...
//    private static final int GESTURE_MODE_ONLY_CALENDAR = 1;
    ...
    private boolean isMeasureContentView = false;//是否测量内容视图
    ...
    private void measureContentView() {
        if (!isMeasureContentView && mContentView != null && mMonthView != null) {
            /*if (mContentView != null && mMonthView != null) {
                int h = getHeight() - mItemHeight
                        - (mDelegate != null ? mDelegate.getWeekBarHeight() : CalendarUtil.dipToPx(getContext(), 40)) - CalendarUtil.dipToPx(getContext(), 1);
