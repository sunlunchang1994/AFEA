...
public class WeekBar extends LinearLayout {
    ...
    private String WEEK_BAR_BACK_NAME = "com.slc.code.ui.weight.calendar.WeekBar";

    public WeekBar(Context context) {
        super(context);
        if (WEEK_BAR_BACK_NAME.equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if (WEEK_BAR_BACK_NAME.equalsIgnoreCase(getClass().getName())) {
